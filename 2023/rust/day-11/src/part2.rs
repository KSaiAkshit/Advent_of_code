...
#[tracing::instrument]
pub fn process(input: &str, expansion_size: i64) -> miette::Result<String, AocError> {
...
mod tests {
    ...
    #[case(100, 8410)]
    #[test_log::test]
    fn test_process(#[case] expansion_amount: i64, #[case] expected: i64) -> miette::Result<()> {
        let input = "...#......
.......#..
#.........
..........
...
.......#..
#...#.....";
        assert_eq!(expected.to_string(), process(input, expansion_amount)?);
        Ok(())
    }
}
